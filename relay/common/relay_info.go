...
type RelayInfo struct {
	...
	EdgeBillingFacts       *edgedto.EdgeBillingFactsV1
	...
	EdgeConsumeLogSnapshot *edgedto.EdgeConsumeLogSnapshotV1
	...
	// EdgeSnapshot* pins the immutable snapshot carried by the local reservation.
