...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.Audit())
	{
	...
	geminiRouter.Use(middleware.Audit())
	{
	...
	geminiCompatibleRouter.Use(middleware.Audit())
	{
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Audit(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.Audit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.Audit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.Audit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.Audit(), middleware.Distribute())
	{
